...
INSERT INTO `__new_agent_assignments`("id", "goal_id", "initiative_id", "task_id", "title", "description", "agent_id", "status", "completed_at", "sort_order", "created_at", "updated_at") SELECT "id", "goal_id", "initiative_id", "task_id", "title", "instructions", "agent_id", "status", "completed_at", "sort_order", "created_at", "updated_at" FROM `agent_assignments`;--> statement-breakpoint
